...
def get_params():
    ...
    parser.add_argument('--modes', type=int, default=36, help='Number of Fourier modes')
    parser.add_argument('--width', type=int, default=20, help='Model width parameter')
    parser.add_argument('--bsize', type=int, default=1, help='Batch divisor for calculating batch_size')
    # Training schedule
    ...
    parser.add_argument('--lbfgs_epochs', type=int, default=1500, help='Number of LBFGS epochs')
    ...
    parser.add_argument('--nu', type=float, default=1e-3, help='Viscosity nu')
    parser.add_argument('--rf', type=int, default=8, help='Resolution factor for super-resolution')
    parser.add_argument('--orders_v', type=int, nargs=2, default=[4,4], help='Spline orders for velocity potential')
